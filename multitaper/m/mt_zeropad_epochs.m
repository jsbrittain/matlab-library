function  [ epochs, erptime, epochindex ] = mt_zeropad_epochs(dat, rate, trig_start, trig_end, opt_str )
%function  [ epochs, erptime, epochindex ] = mt_zeropad_epochs(dat, rate, trig_start, trig_end, opt_str )
%
% Construct epochs with time-domain zero padding
%
% Input parameters
%       dat         Data vector
%       rate        Sampling rate
...
for n = (1:size(epochs,3))
    ...
    for m = (1:size(epochs,2))
        ...
        epochs(:,m,n) = [ dat1; zeros(N-length(dat1),1) ];
