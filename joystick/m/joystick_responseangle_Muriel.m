function [rangle,joystick]=joystick_responseangle_Muriel( joystick, filterpts100 )
...
for n=(1:length(joystick))
   ...
   %  startpt - 1;
    ...
    if ( isempty(joystick(n).responseangle) )
        rangle(n) = NaN;
    else
