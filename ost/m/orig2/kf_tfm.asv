function [f,Pf,t,Pt]=kf_tfm(f,t,cl,f_max,Q,x0,P0);
%function [f,Pf,t,Pt]=kf_tfm(f,t,cl,f_max,Q,x0,P0);
%
...
%
% Optional inputs for x0 and Pp in order to allow efficient smoothing
% (see, for example, kf_tfmfb.m - Forward-backward smoothing)
%
...
if (nargin>5)
    init_cond=1;            % Initial conditions provided
end;
...
if (init_cond)      % If initial conditions provided use them instead of calculated
    x(:,1)=x0;
    P(:,1)=P0;
end;
xp=x(:,1);
