function [sp,Psp]=kf_tfspm_unvstab2(sp,cl,Q,smooth,p_halfwidth);
%
...
%
% Calculates local power spectra for periodogram variance from evolving
% spectrum.
%
...
for ind=2:M
    ...
    R=(abs(x(:,ind-1)).^2)./cl(ind).seg_tot;
    % Kalman filter
