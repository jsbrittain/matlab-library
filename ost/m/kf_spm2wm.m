function [sp,Psp,freqs]=kf_spm2wm(dat1,dat2,trig,offset,duration,rate,seg_pwr,opt_str);
%function [sp,Psp,freqs]=kf_spm2wm(dat1,dat2,trig,offset,duration,rate,seg_pwr,opt_str);
%
% Hybrid Kalman-Fourier analysis, type 2
%
% Full matrix implementation (except returned spectral matrices), NOT
% reduced vector implementation.  DOES NOT WORK: Construction of R forces
...
[sp,Psp]=kf_tfspm2wm(sp,cl,Qpercentage/100,smooth);
