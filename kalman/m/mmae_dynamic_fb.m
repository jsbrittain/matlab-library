function [condx, condP]=mmae_dynamic_fb(dat, Q, R, theta, H, filters);
%function [condx, condP]=mmae_dynamic_fb(dat, Q, R, theta, H, filters);
%
% Multi-Modal Adaptive Estimator (MMAE)
% Implementation: Dynamic Model ; Multivariate ; Forward-Backward smoothing
%
...
%
% function [condx, condP]=mmae_dynamic_fb(dat, Q, R, theta, filters);
