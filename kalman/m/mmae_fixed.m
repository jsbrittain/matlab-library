function [condx,condP]=mmae_fixed(dat, Q, R, theta, H, filters);
%function [condx, condP]=mmae_fixed(dat, Q, R, theta, H, filters);
%
...
for j=1:filters
	...
	p(:,:,j)=(1/filters)*I;     % Set all models equally likely
...
% Recurse MMAE-fixed algorithm
for t=1:len
	% Get next measurement
	newz=dat(t,:)';

    % Perform recursive Dynamic-MMAE estimation
    [condx(:,t), condP(:,:,t), Pp, xp, p]=mmae_fixedr(newz, Q2, R2, theta, H, Pp, xp, p, channels, filters);
