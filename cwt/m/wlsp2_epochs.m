function [Wsp,wlparam]=wlsp2_epochs(dat1,dat2,rate,df,frange,opt_str,mother,wlopt);
%function [Wsp,wlparam]=wlsp2_epochs(dat1,dat2,rate,df,frange,opt_str,mother,wlopt);
%
...
[Wsp,wlparam]=wlsp2(dat1,dat2,trig,offset,duration,rate,df,frange,opt_str,mother,wlopt);
