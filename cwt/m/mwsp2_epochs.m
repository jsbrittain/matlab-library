function [Wsp,wlparam]=mwsp2_epochs(dat1,dat2,rate,df,frange,opt_str,mother,wlopt)
%function [Wsp,wlparam]=mwsp2_epochs(dat1,dat2,rate,df,frange,opt_str,mother,wlopt);
%
% Multi-wavelet spectrum analysis (Type 2)
%
...
[Wsp,wlparam]=mwsp2(dat1,dat2,trig,offset,duration,rate,df,frange,opt_str,mother,wlopt);
